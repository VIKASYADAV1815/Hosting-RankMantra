          ...
          {features.map((feature, idx) => {
            ...
            return (
              <div
                ...
                className="bg-white hover:bg-gradient-to-br hover:from-white hover:to-[#E00C15]/[0.04] p-8 relative overflow-hidden transition-all duration-300 flex flex-col items-center text-center group min-h-[260px] cursor-default"
                style={{
