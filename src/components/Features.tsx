...
import { Server, Headset, Shield, Zap, Package, Lock, Plus } from "lucide-react";

const features = [
  { icon: Server, title: "Fast Servers", desc: "Enterprise-grade hardware ensuring maximum performance and reliability." },
  { icon: Headset, title: "Best Support", desc: "24/7 expert assistance for all your technical and account queries." },
  { icon: Shield, title: "ActivGuard Security", desc: "Advanced protection against malware, DDoS, and security threats." },
  { icon: Zap, title: "Fast load time", desc: "Optimized infrastructure for lightning-fast page loading speeds." },
  { icon: Package, title: "Included Apps", desc: "1-click installation for hundreds of popular web applications." },
  { icon: Lock, title: "Private Domain", desc: "Secure and private domain registration to protect your identity." },
];
  ...
  return (
    <section className="py-28 bg-[#FAFAFA] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between pb-12 mb-16 border-b-2 border-[#4B4B4B]/10">
          <div className="max-w-xl">
            <h2 className="text-4xl font-bold tracking-tight text-[#4B4B4B] sm:text-5xl">
